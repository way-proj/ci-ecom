 <section class="pt-3 pb-3 page-info section-padding border-bottom bg-white">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <a href="#"><strong><span class="mdi mdi-home"></span> Cart</strong></a> 
               </div>
            </div>
         </div>
      </section>
               ...
               <div class="col-md-12">
                  <div class="card card-body cart-table">
                        ...
                        <table class="table cart_summary">
                              ...
                              <?php 
                               ...
                               $cart = $this->cart->contents();
                                ...
                                echo form_hidden('cart[' . $item['id'] . '][qty]', $item['qty']);
                                    ...
                                    ?>
                              <tr>
                                 <td class="cart_product"><a href="#"><img class="img-fluid" src="<?php echo site_url(); ?>admin/upload/product_bestseller/<?php echo @$item['image'];?>" alt=""></a></td>
                                 ...
                                 <td class="price"><span>₹ <?php echo number_format($item['price'],2);?></span></td>

                                 <td class="qty">

                                    <div class="input-group">
                                       <span class="input-group-btn"><button  onclick="decrement_quantity(<?php echo $item['id'];?>,<?php echo $rowid;?>,<?php echo $item['price'];?>,<?php echo $item['qty'];?>)" class="btn btn-theme-round btn-number" type="button">-</button></span>
                                       ...
                                       <button onclick="increment_val(<?php echo $item['id'];?>,<?php echo $rowid;?>,<?php echo @$item['price'];?>)"class="btn btn-theme-round btn-number" type="button">+</button>
                                       </span>
                                    </div>
                                 </td>
                                 <td class="price">
                           ...
                           <tfoot>
                              ...
                              <tr>
                                 ...
                                 <td class="text-danger" colspan="2"><strong> <span  id="allamnt">
                     <i class='fa fa-inr'></i>
                    <?php echo number_format(@$grand_total,2);?>
                     ...
                     <a href="<?php echo base_url();?>Checkout/checkout"><button class="btn btn-secondary btn-lg btn-block text-left" type="button"><span class="float-left"><i class="mdi mdi-cart-outline"></i> Proceed to Checkout </span><span class="float-right"><strong>₹  <span  class="allamnt2">
                     <i class='fa fa-inr'></i>
                    <?php echo number_format(@$grand_total,2);?>
