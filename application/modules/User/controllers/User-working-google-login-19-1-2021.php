...
$data['GLoginUrl'] = $authUrl; 
	...
	/* $google_client->setClientSecret("560107265073-k8l26usk6llbl9v3ia3esps6pkmf9mu3.apps.googleusercontent.com");
	 ...
	 if(isset($_GET['code']))
	 {
		...
		$login_button = '<a  href="'.$google_client->createAuthUrl().'"><img scr="'.base_url().'assets/sign-in-with-google.png" /> </a>';
...
public function send_mail(){
        ...
        $link = 'http://localhost:8080/restaurants/User/regenrate_pass/'.$res->customer_id.'/'.$active_code;
