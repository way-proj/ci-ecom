                        ...
                        <h3>Sign into your account</h3>
						 ...
						 <form action="<?php echo base_url()?>User/signin" method="post">
                            ...
                            <div class="form-group mb-0 clearfix">
                                ...
                                <a href="<?php echo base_url()?>User/forgot_password" class="forgot-password">Forgot Password</a>
                            </div>
                            ...
                            <ul class="social-list">
                               ...
                               ?>
                                ...
                                <li><a href="<?php echo $userData->link; ?>" class="google-color"><i><img class="user_img" src="<?php echo $userData->picture; ?>" style="border-radius:25px;" /></i><span style="overflow: hidden; text-overflow: ellipsis; width: auto; display: block; white-space: nowrap; padding-left: 6px;"><?php echo $userData->name; ?></span></a></li>
                          <!--       <header id="info">
