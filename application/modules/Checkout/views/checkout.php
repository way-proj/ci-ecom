 ...
 <link rel="stylesheet" href="<?php echo site_url(); ?>common/cart/plugins/bootstrap/bootstrap.min.css">
        <!-- Font Awesome -->
                                              ...
                                              //echo"dfg";
                                                ...
                                                <form class="delivery_address" method="post" action="<?php echo site_url();?>Checkout/login_check">
                                                    <div class="form-group">
                                                        ...
                                                        <input  required="" type="text" name="billing_name" class="form-control" value="<?php echo @$cust_data->firstname;?>" />
                                                    ...
                                                    <div class="row">
                                                         <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Country</label>
                                                                <input required="" type="text" name="billing_country" class="form-control" value="<?php echo @ @$cust_data->country;?>" />
                                                            </div>
                                                        </div>
                                             ...
                                             <option value="<?php echo @$value->name;?>" ><?php echo @$value->name;?></option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>City</label>
                                                                <input required=""  type="text" name="billing_city" class="form-control" value="<?php echo @$cust_data->city;?>" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
