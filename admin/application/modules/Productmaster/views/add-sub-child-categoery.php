               ...
               <div class="content-wrapper">
                ...
                <h2>Sub Child Categories</h2>
                <?php
                $brand_array[]= @$single_cat_data->store;
                $cat_array[]= @$single_cat_data->cat_id;
               // print_r($brand_array);

                $sub_cat_array[]= @$single_cat_data->sub_cat_id;
                
                ?>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a class="active" href="<?php echo base_url()?>Productmaster/childsubcategory">Sub Child Categories</a></li>
                    ...
                    <a href="<?php echo base_url();?>/Productmaster/childsubcategory" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Cancel"><i class="fa fa-reply"></i></a></div>
                </ol>
             ...
             <div class="col-md-12">
              ...
              <div class="nav-tabs-custom">
                ...
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Add Sub Child Category</h3>
                 </div>
 ...
 function get_id(id){
   $("#photo_"+id).val(id);
           ...
           <form action="<?php echo base_url();?>/Productmaster/save_sub_child_category_data" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
                ...
                <div class="col-sm-10">
                <select required=""  name="category_id" id="category_id" onchange="get_cat_id(this.value)" name="cat_id" id="input-store" class="form-control">
               ...
               <div class="form-group" id="onchange_div">
                <label class="col-sm-2 control-label" for="input-subtract">Sub Category<span style="color:red">*</span></label>
                <div class="col-sm-10">
                <select  id="sub_cat_id" name="subcat_id" id="input-store" class="form-control">
                 </select>
                </div>
                </div>
                
                <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-name1">Sub Child Category<span style="color:red">*</span></label>
                <div class="col-sm-10">
                   
                <input  type="text" name="sub_child_category_name" id="category_name" value="<?php echo set_value('sub_child_category_name'); ?><?php echo @$single_cat_data->sub_child_category_name;?>" placeholder="Sub Child Category Name" class="form-control">
                <?php echo form_error('category_name', '<div class="error"><p style="color:red">', '</p></div>'); ?>
                </div>
                </div>
                <div class="form-group">
