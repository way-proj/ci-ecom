               ...
               <div class="content-wrapper">
                ...
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a class="active" href="<?php echo base_url()?>Productmaster/charity_list">Add New Arrivals</a></li>
                    ...
                    <a href="<?php echo base_url();?>/Productmaster/charity_list" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Cancel"><i class="fa fa-reply"></i></a></div>
                </ol>
        ...
        <div style="display: none" id="glob_msg" class="alert alert-block alert-error">
             ...
             <div class="text-center"> 
              ...
              <div class="nav-tabs-custom">
                ...
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Add Arrivals</h3>
                 </div>
                <div class="panel-body">
                <form action="<?php echo base_url();?>/Productmaster/save_charity_data" method="post" enctype="multipart/form-data" class="form-horizontal">
                
                <input type="hidden" name="charity_id" value="<?php echo @$this->uri->segment(3);?>">
                ...
                <div class="col-sm-10">
                <input type="text" name="name" id="name" value="<?php echo set_value('name'); ?><?php echo @$single_cat_data->name;?>" placeholder="Product Name" class="form-control">
                <?php echo form_error('charity_name', '<div class="error"><p style="color:red">', '</p></div>'); ?>
                </div>
                </div>
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-name1">Product Price <span style="color:red">*</span></label>
                <div class="col-sm-10">
                <input type="text" name="price" id="price" value="<?php echo set_value('name'); ?><?php echo @$single_cat_data->price;?>" placeholder="Price" class="form-control">
                <?php echo form_error('price', '<div class="error"><p style="color:red">', '</p></div>'); ?>
                </div>
                </div>

                <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-name1">Product Photo <span style="color:red">*</span></label>
                <div class="col-sm-10">
                <input type="file" name="logo" id="logo" class="form-control">
                <input type="hidden" name="old_logo" value="<?php echo @$single_cat_data->logo;?>">
               <?php
  if(!empty($single_cat_data->logo)){
      ?>
<img src="<?php echo base_url().'upload/charity/'.$single_cat_data->logo?> " width="50">
      <?php
  }
               ?>
                </div>
                ...
                <textarea  name="description" id="description" class="tincyeditor"><?php echo @$single_cat_data->description;?></textarea>
                 ...
                 <div class="form-group">
                <label class="col-sm-2 control-label" for="input-meta-description1">Bullet Description</label>
                <div class="col-sm-10">
