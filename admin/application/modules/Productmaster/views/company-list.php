 <div class="content-wrapper">
               <div class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a class="active" href="<?php echo base_url()?>Productmaster/company_list">Company</a></li>
                        
                <div class="pull-right"><a href="<?php echo base_url()?>Productmaster/add_company" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add New"><i class="fa fa-plus"></i></a> <a href="#" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Rebuild"><i class="fa fa-refresh"></i></a>
                                        ...
                                        ?>
                                          <tr>
                                           <!--  <td><?php echo $i;?></td> -->
                                            ...
                                            <td><img style="width:80px;height:80px;"src="<?php echo base_url(); ?>upload/company_logo/<?php echo $row->image_url;?>"></td>
                                            <!-- <td><?php echo substr($row->description,0,50);?></td> -->
                                            <td>
                                                            <a  style="padding-left: 2em;" href="<?php echo site_url();?>Productmaster/add_company/<?php echo @$row->id;?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a> 
                                                            <a  style="padding-left: 2em;" onclick="deletes('company_details','id','<?php echo $row->id; ?>','Blog_Category')"><span class="glyphicon glyphicon glyphicon-trash" aria-hidden="true"></span></a> 
