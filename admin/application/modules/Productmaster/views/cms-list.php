<div class="content-wrapper">
		<div class="content-header">
			...
			<h2>CMS</h2>
				...
				<li><a class="active" href="<?php echo base_url()?>Productmaster/cms_list">Brand</a></li>
				<div class="pull-right"><a href="<?php echo base_url()?>Productmaster/add_cms" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add New"><i class="fa fa-plus"></i></a> <a href="#" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Rebuild"><i class="fa fa-refresh"></i></a>
                                    ...
                                    <thead>
                                        ...
                                        ?>
                                         ...
                                         <td>InActive</td>
                                           ...
                                           ?>
                                        <td>
                                        <a  style="padding-left: 2em;" href="<?php echo site_url();?>Productmaster/add_cms/<?php echo @$row->id;?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a> 
                                        <a  style="padding-left: 2em;" onclick="deletes('tbl_cms','id','<?php echo $row->id; ?>','cms-list')"><span class="glyphicon glyphicon glyphicon-trash" aria-hidden="true"></span></a> 
