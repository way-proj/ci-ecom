 <div class="content-wrapper">
               <div class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a class="active" href="<?php echo base_url()?>Productmaster/attribute_list">Attribute</a></li>
                       ...
                       <div class="pull-right"><a href="<?php echo base_url()?>Productmaster/add_attribute" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add New"><i class="fa fa-plus"></i></a> <a href="#" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Rebuild"><i class="fa fa-refresh"></i></a>
                                        ...
                                        ?>
                                          <tr>
                                           <!--  <td><?php echo $i;?></td> -->
                                            ...
                                            <td>
                                                            <a  style="padding-left: 2em;" href="<?php echo site_url();?>Productmaster/add_attribute/<?php echo @$row->id;?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a> 
        ...
        <script>
            ...
            function view(id)
            {
                ...
                {
                    //alert("dfggf");
                    var url = "<?php echo base_url('Productmaster/view_attr'); ?>";
                    $.ajax({
                        url: url,
                        data: {'id': id},
                        type: "POST",
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h4 style="color:green"class="modal-title" id="myModalLarge">Attribute Details</h4></center>
                </div>
