               ...
               <div class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a class="active" href="<?php echo base_url()?>Productmaster/material_list">Material</a></li>
                       ...
                       <div class="pull-right"><a href="<?php echo base_url()?>Productmaster/add_material" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add New"><i class="fa fa-plus"></i></a> <a href="#" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Rebuild"><i class="fa fa-refresh"></i></a>
                                    ...
                                    <table id="category_view" class="table table-bordered table-striped">
                                        ...
                                        ?>
                                          <tr>
                                            ...
                                            <td>
                                            <a  style="padding-left: 2em;" href="<?php echo site_url();?>Productmaster/add_material/<?php echo @$row->id;?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a> 
                                            <a  style="padding-left: 2em;" onclick="deletes('tbl_materials','id','<?php echo $row->id; ?>','material_list')"><span class="glyphicon glyphicon glyphicon-trash" aria-hidden="true"></span></a> 
                                           </td>
                                           </tr>
                                          <?php }?>
                                        </tbody>
