			<?php
                $cat_array[]= @$single_cat_data->store;
              ?>              
			  <div class="content-wrapper">
                ...
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a class="active" href="<?php echo base_url()?>Productmaster/category">Categories</a></li>
                    ...
                    <a href="<?php echo base_url();?>/Productmaster/category" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Cancel"><i class="fa fa-reply"></i></a></div>
                </ol>
             ...
             <div class="col-md-12">
              ...
              <div class="nav-tabs-custom">
                ...
                <form action="<?php echo base_url();?>/Productmaster/save_category_data" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
                ...
                <option value="<?php echo $value->id;?>" <?php if(in_array($value->id,$cat_array)){ echo 'selected="selected"';}?>><?php echo $value->brand_name;?></option>
                <?php } ?>
                ...
                <label class="col-sm-2 control-label" for="input-name1">Category Name <span style="color:red">*</span></label>
                <div class="col-sm-10">
                   
                <input   type="text" name="category_name" id="category_name" value="<?php echo set_value('category_name'); ?><?php echo @$single_cat_data->category_name;?>" placeholder="Category Name" class="form-control">
