                                        ...
                                        ?>
                                          <tr>
                                           <!--  <td><?php echo $i;?></td> -->
                                            ...
                                            <td style="text-align: center;"><span style="max-width: 120px;height: 60px;display: inline-flex;align-items: center;justify-content: center;"><img style="width:100%" src="<?php echo base_url(); ?>upload/cat_images/<?php echo $row->image_url;?>"></span></td>
											<td style="text-align: center;"><span style="max-width: 120px;display: inline-flex;align-items: center;justify-content: center;"><img style="width:100%"  src="<?php echo base_url(); ?>upload/cat_images/<?php echo $row->brand_image;?>"></span></td>
										
                                            <td><?php echo substr($row->description,0,50);?></td>
                                            <td>
                                            <a  style="padding-left: 2em;" href="<?php echo site_url();?>Productmaster/add_brand/<?php echo @$row->id;?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a> 
                                            <a  style="padding-left: 2em;" onclick="deletes('brand_details','id','<?php echo $row->id; ?>','Blog_Category')"><span class="glyphicon glyphicon glyphicon-trash" aria-hidden="true"></span></a> 
