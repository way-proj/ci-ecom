 <div class="content-wrapper">
               <div class="content-header">
                ...
                <div class="pull-right"><a href="<?php echo base_url()?>Productmaster/add_category" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add New"><i class="fa fa-plus"></i></a> <a href="#" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Rebuild"><i class="fa fa-refresh"></i></a>
                                        ...
                                        ?>
                                          <tr>
                                           ...
                                           <td><?php echo ucfirst($row->brand_name);?></td>
                                            ...
                                            <td>
                                                            <a  style="padding-left: 2em;" href="<?php echo site_url();?>Productmaster/add_category/<?php echo @$row->id;?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a> 
                                                            <a  style="padding-left: 2em;" onclick="deletes('category_details','id','<?php echo $row->id; ?>','Blog_Category')"><span class="glyphicon glyphicon glyphicon-trash" aria-hidden="true"></span></a> 
