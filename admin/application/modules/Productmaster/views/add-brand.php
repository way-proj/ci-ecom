               ...
               <div class="content-wrapper">
                ...
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a class="active" href="<?php echo base_url()?>Productmaster/brand_list">brand</a></li>
        ...
        <div style="display: none" id="glob_msg" class="alert alert-block alert-error">
             ...
             <div class="text-center"> 
              ...
              <div class="nav-tabs-custom">
                ...
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Add Brand</h3>
                 </div>
                <div class="panel-body">
                <form action="<?php echo base_url();?>/Productmaster/save_brand_data" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
                <ul class="nav nav-tabs">
                <input type="hidden" name="brand_id" value="<?php echo @$this->uri->segment(3);?>">
                ...
                <label class="col-sm-2 control-label" for="input-name1">Brand Name <span style="color:red">*</span></label>
                <div class="col-sm-10">
                <input type="text" name="brand_name" id="brand_name" value="<?php echo set_value('brand_name'); ?><?php echo @$single_cat_data->brand_name;?>" placeholder="Brand Name" class="form-control">
				...
				<input type="hidden" name="old_image" value="<?php echo @$single_cat_data->image_url;?>">
				</div>
				</div>
                ...
                <input type="file" name="update_photo1"  onchange="loadFile1(event)">
				<input type="hidden" name="old_logo" value="<?php echo @$single_cat_data->brand_image;?>">
				</div>
				</div>
                <div class="list-group-item" style="border: 0px !important;">
                       <div class="row">
                                           ...
                                           <div class="col-md-9"> 
                                               <img id="output1" style="width: 40px;" src="<?php echo base_url();?>upload/cat_images/<?php echo @$single_cat_data->brand_image; ?>">
                                           </div>
                                       </div>
                </div>
            ...
            <?php } else{?>
                ...
                <label class="col-sm-2 control-label">Brand Image</label>
                <div class="col-sm-10">
                <input type="file" name="file1"  onchange="loadFile1(event)">
                </div>
                </div>
