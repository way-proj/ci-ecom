<div class="content-wrapper">
               ...
               <div class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a class="active" href="<?php echo base_url()?>Productmaster/cms_list">Contact List</a></li>
                                    ...
                                    <table id="category_view" class="table table-bordered table-striped">
                                        ...
                                        ?>
                                          <tr>
                                            ...
                                            <td>
                  <a  style="padding-left: 2em;" onclick="deletes('tbl_contact','id','<?php echo $row->id; ?>','contact_list')"><span class="glyphicon glyphicon glyphicon-trash" aria-hidden="true"></span></a> 
