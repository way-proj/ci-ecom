    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <li><a href="<?php echo base_url() . "Productmaster/company_list" ?>"><i class="fa fa-circle-o text-aqua"></i>Company</a>
                  ...
                  <li><a href="#"><i class="fa fa-circle-o text-aqua"></i>Attributes</a>
					  ...
					  <li><a href="<?php echo base_url() . "Productmaster/material_list" ?>"><i class="fa fa-circle-o text-aqua"></i>Materials</a>
                  </li>
                    <li><a href="<?php echo base_url() . "Productmaster/ProductList" ?>"><i class="fa fa-circle-o text-aqua"></i>Products</a></li>
                    <li><a href="<?php echo base_url() . "Productmaster/upload_product_csv" ?>"><i class="fa fa-circle-o text-aqua"></i>Upload products by csv</a></li>
                  ...
                  <li><a href="<?php echo base_url() . "Productmaster/manage_blogs" ?>"><i class="fa fa-circle-o text-aqua"></i>Blog List</a>
                  </li>
          ...
          <!--   <li class="treeview">
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-table"></i> <span>New Arrivals</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                  <li><a href="<?php echo base_url() . "Productmaster/charity_list" ?>"><i class="fa fa-circle-o text-aqua"></i>Arrivals List</a></li>    
            ...
            <li class="treeview">
                <a href="#">
                <i class="fa fa-table"></i> <span>Special offer</span>
                <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
                </span>
                </a>
                <ul class="treeview-menu">
                 <li><a href="<?php echo base_url() . "Bestseller/manage_bestseller" ?> "><i class="fa fa-circle-o text-aqua"></i>Special offer</a>
                 </li> 
                </ul>
			</li>
                 <li class="treeview">
